...
function MintCard(props){
  ...
  const mint=(tokenid)=>{
    if (tokenid % 3 == 0){
        const nft = {id:tokenid, img:nft1_img, name:"Queens Ape Hand",
        ...
        const nft = {id:tokenid, img:nft2_img, name:"Kings Ape Hand",
                                         first_slot:"",
                                         second_slot:"", 
                                         third_slot:""};
...
return(
    <div>
      ...
      />
        <Paper elevation={3}>
            <Button sx={{textTransform: 'none'}} onClick={()=>{handleClickOpen(props.id)}}>
                <Box
                    sx={{
                    ...
                    <Grid container alignItems="center" justifyContent="center">
                      <Grid item xs={12}>
                      <Typography sx={{mt:5}} variant="body1" gutterBottom>{props.ownerAddress}</Typography>
                      </Grid>
                      <Grid item xs={12}>
                      <Typography sx={{mt:2}} variant="body1" gutterBottom>{props.id}</Typography>
                      </Grid>
                    </Grid>
                </Box>
            </Button>
            <Grid container alignItems="center" justifyContent="center">
              <Grid container alignItems="center" justifyContent="center" item xs={12}>
                <Typography sx={{mt:5}} variant="h5" gutterBottom>PRICE : {props.buyPrice} SOL</Typography>
                <Typography sx={{mt:5}} variant="h5" gutterBottom>Per Read : {props.tansuFee} SOL</Typography>
              </Grid>
              <Grid container alignItems="center" justifyContent="center" item xs={12}>
                <Button sx={{mt:1, padding:2, margin:2, backgroundColor:"#ff8c00", "&:hover": {background: "steelblue"}}}
                variant="contained" onClick={()=>{mint(props.id)}} fullWidth>MINT</Button>
              </Grid>
            </Grid>
        </Paper>
    </div>
