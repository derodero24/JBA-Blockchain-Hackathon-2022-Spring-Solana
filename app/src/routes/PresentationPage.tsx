...
import { Box, Grid, Pagination, Paper, TextField, InputLabel, MenuItem, FormControl, Select, Button } from '@mui/material';
...
function Editor(){
  const [slidePages, setSlidePages] = React.useState([1, 2, 3]);
  ...
  return (
    <div>
      ...
      <Button onClick={()=>{addSlide()}}><AddCircleOutline/></Button>
      <Button onClick={()=>{deleteSlide()}}><RemoveCircleOutline/></Button>
    </div>
  )
