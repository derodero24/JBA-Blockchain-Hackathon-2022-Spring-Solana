...
export async function getYourNFTs(){
    const nfts = [{id:0, img:nft1_img, ownerAddress:"0xgngoitnohiethpshth", tansuFee:0.002},
...
export async function getMaterialMarket() {
    const materials = [{id:0, img:nft1_img, ownerAddress:"0xgngoitnohiethpshth", buyPrice:0.2, tansuFee:0},
